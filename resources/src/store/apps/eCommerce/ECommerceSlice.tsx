...
export const EcommerceSlice = createSlice({
  ...
  reducers: {
    ...
    // ADD Item TO CART Define by PIPL
    addItemToCart(state: StateType, action) {
      const product = action.payload;
      state.cartItems = product;
    },

    // ADD Item TO CART Define by PIPL
    addProductList(state: StateType, action) {
      const product = action.payload;
      state.productList = product;
    },

    // ADD Profile Picture Define by PIPL
    addProfilePicture(state: StateType, action) {
      const product = action.payload;
      state.profilePicture = product;
    },
