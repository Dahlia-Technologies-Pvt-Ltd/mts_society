...
class MasterUser extends Authenticatable
{
    ...
    protected $fillable = [
        'name','user_code','username', 'email', 'password', 'phone_number',
        'master_society_ids', 'gender', 'address',
         'country_id', 'state_id', 'city_id',
        'zipcode','usertype','blocked_at','profile_picture', 'status', 'created_by', 'updated_by',
    ];
