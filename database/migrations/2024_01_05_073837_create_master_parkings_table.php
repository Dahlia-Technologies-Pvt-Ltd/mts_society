...
return new class extends Migration
{
    ...
    {
        Schema::create('master_parkings', function (Blueprint $table) {
            $table->id();
            $table->string('parking_name');
            $table->foreignId('master_tower_id')->constrained();
            $table->foreignId('master_wing_id')->constrained()->nullable();
            $table->foreignId('master_floor_id')->constrained();
            $table->foreignId('master_flat_id')->constrained();
    ...
    {
        Schema::dropIfExists('master_parkings');
    }
};
